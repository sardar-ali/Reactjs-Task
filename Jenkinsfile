        ...
        stage("AWS S3 Deployment"){
            ...
            steps{
                withCredentials([usernamePassword(credentialsId: 'my-cloud2', passwordVariable: 'AWS_SECRET_ACCESS_KEY', usernameVariable: 'AWS_ACCESS_KEY_ID')]) {
                    ...
                    aws ecs update-service --service react-app-jenkins-Service-Prod --task-definition react-app-jenkins-task-definition-prod --cluster react-app-jenkins-prod react-app-jenkins-task-definition-prod:2
                    '''
